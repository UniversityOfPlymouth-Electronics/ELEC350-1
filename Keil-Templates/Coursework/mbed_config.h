...
#define MBED_CONF_SD_SPI_CLK                              PC_10                        // set by library:sd[NUCLEO_F429ZI]
#define MBED_CONF_PLATFORM_STDIO_FLUSH_AT_EXIT            1                            // set by library:platform
#define MBED_CONF_SD_SPI_CS                               PA_15                        // set by library:sd[NUCLEO_F429ZI]
...
#define MBED_CONF_SD_SPI_MOSI                             PC_12                        // set by library:sd[NUCLEO_F429ZI]
...
#define MBED_CONF_SD_SPI_MISO                             PC_11                        // set by library:sd[NUCLEO_F429ZI]
